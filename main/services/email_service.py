...
class EmailService:
    ...
    def send_verification_email(user, request=None):
        ...
        send_mail(
            subject,
            plain_message,
            getattr(settings, 'DEFAULT_FROM_EMAIL', 'noreply@autocandidature.com'),
            [user.email],
            fail_silently=False,
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div class="warning">
                        <p><strong>⚠️ Attention :</strong> Ce lien expirera dans 3 jours. Si vous n'avez pas demandé cette réinitialisation, ignorez cet email et votre mot de passe restera inchangé.</p>
                    </div>
                </div>
                <div class="footer">
                    <p>© 2024 AutoCandidature - Tous droits réservés</p>
